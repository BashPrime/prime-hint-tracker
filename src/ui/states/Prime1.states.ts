...
import { PRIME_1_LOCATIONS_WITH_ITEMS, PRIME_1_MAJOR_UPGRADES } from "@/data/Prime1.data";
...
export const prime1UnhintedItemOptionsSelector = atom<HintOption[]>(createOptions([...PRIME_1_MAJOR_UPGRADES], true));
