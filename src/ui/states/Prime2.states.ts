...
export const prime2VioletHintsState = atomWithReset<Hint[]>([
  ...PRIME_2_VIOLET_HINTS,
]);
export const prime2AmberHintsState = atomWithReset<Hint[]>([
  ...PRIME_2_AMBER_HINTS,
]);
export const prime2EmeraldHintsState = atomWithReset<Hint[]>([
  ...PRIME_2_EMERALD_HINTS,
]);
export const prime2CobaltHintsState = atomWithReset<Hint[]>([
  ...PRIME_2_COBALT_HINTS,
]);
